...
df_yield['Pays_EN'] = df_yield['Pays'].map(french_to_english).fillna(df_yield['Pays'])

yield_countries = set(df_yield['Pays_EN'].unique())
centroid_countries = set(centroids['COUNTRY'].unique())

missing = yield_countries - centroid_countries
print(f"Total translated yield countries: {len(yield_countries)}")
print(f"Total centroid countries: {len(centroid_countries)}")
print(f"Missing in centroids file ({len(missing)}):")
